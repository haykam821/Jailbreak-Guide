...
Testers have shared their experiences, which can be viewed [here]({% site.github.url %}/unc0ver-experiences).
...
For a follow list of things that can go wrong, see [this post]({% site.github.url %}/unc0ver-errors).